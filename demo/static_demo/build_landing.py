# ruff: noqa: E501
"""Build the Cogniflow landing page (Slice D) from REAL captured runs.
...
<title>Cogniflow &mdash; the auditable, self-hostable belief ledger for agents</title>
<style>
...
<section>
 ...
 <p class="sub">Plain RAG can tell you what's true <em>now</em>. Cogniflow tells you what your agent believed at any <em>past</em> moment &mdash; and proves it. Temporally-correct context and cited answers, running in your own VPC, where your data never leaves.</p>
 <div class="cta">
...
<section>
 ...
 <p class="lede">Modern RAG (and hosted memory) has no time axis. It answers from whatever it retrieves today. Cogniflow filters context to the moment you ask about, so the answer is temporally correct &mdash; and cites the fact it stood on.</p>
 <table>
  <thead><tr><th>Same question, add "as of 2015"</th><th>Answer</th></tr></thead>
  <tbody>
   <tr><td class="miss">Plain RAG</td><td class="miss">Can't isolate the past &mdash; no time axis. It sees both the old and new fact and hedges or picks wrong.</td></tr>
...
<section>
 ...
 <p class="lede">Not a worse hosted-memory service. The answer to a question their governed cloud structurally can't answer &mdash; for the regulated buyer who can't send data out. We tie on retrieval (we inherit Graphiti's); we win where they're blank.</p>
 <table>
  <thead><tr><th>Capability</th><th>Cogniflow</th><th>Hosted recall-optimized memory</th></tr></thead>
  <tbody>
   <tr><td>Standard retrieval / recall</td><td class="tie">Tie &mdash; inherited, not a win</td><td class="win">Strong</td></tr>
   <tr><td>Temporal correctness / as-of replay</td><td class="win">Yes</td><td class="miss">&mdash; no time axis</td></tr>
   <tr><td>Auditable provenance &mdash; "why did this change?"</td><td class="win">Yes</td><td class="miss">&mdash;</td></tr>
   <tr><td>System-time replay (what did it <em>know</em> then)</td><td class="win">Yes</td><td class="miss">&mdash;</td></tr>
   <tr><td>Self-hostable / in-VPC / data never leaves</td><td class="win">Yes</td><td class="miss">&mdash; hosted SaaS</td></tr>
  </tbody>
 </table>
...
<section>
 <p class="eyebrow">Real benchmark &mdash; every number from a live run</p>
...
<section>
 ...
 <h2>What we are &mdash; and what we're not</h2>
 <ul class="b">
  <li><b>Structured input is deterministic.</b> Facts you assert (OKF <code>fact</code> keys) get precise temporal validity. Facts extracted from raw prose are only as good as the extraction LLM &mdash; each served fact is labeled with its confidence, so nothing is laundered.</li>
  ...
  <li><b>Not "first" at temporal RAG.</b> Validity filters and temporal-graph RAG exist. What we ship is honest <em>system-time replay</em> &mdash; the un-knowing invariant &mdash; as auditable, self-hostable infrastructure.</li>
...
<section style="border-bottom:none">
 ...
 <p class="lede">Your infrastructure, your LLM, your embedder &mdash; your data never leaves. For an audit product, the strongest CTA is: read the code that produces the audit trail.</p>
 <div class="cta">
...
<footer>
 Cogniflow &mdash; temporal, self-falsifying belief substrate for agentic RAG. Apache-2.0.
...
document.getElementById("proof").innerHTML =
  ...
  `<div class="r x">Plain RAG, as of 2015 &nbsp;&rarr;&nbsp; can't answer it at all &mdash; no temporal axis.</div>`;
...
document.getElementById("panels").innerHTML =
  panel("standard","Standard questions","Stable facts that don't change. Both do well &mdash; an honest tie.")+
