...
also carry a `fact` triple + `year` (what Cogniflow ingests, with the year as the
...
answers the stale city. Cogniflow knows Denver superseded Boston and answers the current
